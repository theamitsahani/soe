...
val MIGRATION_11_12 = object : Migration(11, 12) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE schools ADD COLUMN mapLink TEXT NOT NULL DEFAULT ''")
        db.execSQL("ALTER TABLE schools ADD COLUMN latitude REAL")
        db.execSQL("ALTER TABLE schools ADD COLUMN longitude REAL")
        db.execSQL("ALTER TABLE tasks ADD COLUMN mapLink TEXT NOT NULL DEFAULT ''")
